...
public class LocalDates {
    public static void main(String[] args){
        ...
        LocalDate alonzosBirthday1 = LocalDate.of(1903,6,14);
        System.out.println("alonzosBirthday1: " + alonzosBirthday1);
        LocalDate alonzosBirthday2 = LocalDate.of(1903, Month.JUNE, 14);
        System.out.println("alonzosBirthday2: " + alonzosBirthday2);
